package com.kaitait.droidtemplate.app.widgets;
...
public class ValidatingField
{
    ...
    private Observable<String> GetValueStream()
    {
        ...
        {
            this.value_stream = FieldUtils.ToObservable(GetValidatableField())
    ...
    public ObservableField<Object> GetErrorObservableField()
    {
        if (this.error_observable_field == null)
        {
            ...
            this.error_observable_field = FieldUtils.ToField(readable_error);
        }
